...
import { z } from "zod";
import { FiPlus, FiSearch, FiArrowUp, FiArrowDown } from "react-icons/fi";
...
const boatsSearchSchema = z.object({
  ...
  sortBy: z.enum(["name", "capacity", "provider_name", "jurisdiction_id"]).optional(),
...
const sortBoats = (boats: Boat[], sortBy: SortableColumn | undefined, sortDirection: SortDirection | undefined) => {
