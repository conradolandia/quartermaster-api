...
export class BookingsService {
     ...
     * @throws ApiError
     */
    public static qrCodeRedirect(data: BookingsQrCodeRedirectData): CancelablePromise<void> {
        return __request(OpenAPI, {
            method: 'GET',
